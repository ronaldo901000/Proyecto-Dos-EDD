    ...
    public void run() {
        ...
        try {
            ...
            try {
                ...
                System.out.println("Buscando producto: " + producto.getCodigoBarra());
                
                origen.eliminar(producto.getCodigoBarra());
                listener.exito(producto, destino);
            } catch (Exception e) {
                System.out.println("excepcion en el catch de insertar y eliminar");
                listener.error(producto, e.getMessage());
            }

        } catch (InterruptedException | ListaException | ElementoNoEncontradoException e) {
            listener.error(producto, e.getMessage());
        }
    }
